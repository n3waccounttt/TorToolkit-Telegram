try:
    ...
    class ExecVars:
        ...
        API_HASH = "e35bf0d832f47f0eeef5b106123298cf"
        API_ID = 23275482
        BOT_TOKEN = "5831202486:AAE3Z9pqDjG-gkWmVooTXDbSCbwmHmV8ZW4"
        BASE_URL_OF_BOT = "http://43.204.228.234"

        # Edit the server port if you want to keep it default though.
        SERVPORT = 80

        # ALLOWED USERS [ids of user or supergroup] seperate by commas
        ALD_USR = [-1001849308872]
        OWNER_ID = 5973905935
